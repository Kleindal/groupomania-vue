                  ...
                  <div class="card border-0">
                    <div class="profile">
                      <div class="profile-img text-primary rounded-top">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#000" viewBox="0 0 400 140.74">
                          <defs style="
                              .cls-2 {
                                fill: #eee;
                                opacity: 1;
                  ...
                  <div class="card-body">
                    <div class="row gx-5">
                      ...
                      <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="line-clamp me-auto">
                            Hello! Yeah, I'm going to meet friend of mine at the
                  ...
                  <div class="card-body">
                    <div class="row gx-5">
                      ...
                      <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="line-clamp me-auto">
                            I'm going to meet my friend of mine at the
                      ...
                      <div class="accordion-item">
                        ...
                        <div id="accordion-profile-body-1" class="accordion-collapse collapse"
                          ...
                          <div class="accordion-body">
                            ...
                            <button type="button" class="btn btn-block btn-lg btn-primary w-100">
                              Save
                            </button>
                          </div>
                        </div>
                    ...
                    <div class="accordion accordion-flush" id="accordion-notifications">
                      <div class="accordion-item">
                        <div class="accordion-header" id="accordion-notifications-1">
                          <a href="#" class="accordion-button text-reset collapsed" data-bs-toggle="collapse"
                            data-bs-target="#accordion-notifications-body-1" aria-expanded="false"
                        ...
                        <div id="accordion-notifications-body-1" class="accordion-collapse collapse"
                          aria-labelledby="accordion-notifications-1" data-parent="#accordion-notifications">
                          <div class="accordion-body">
                            <div class="row align-items-center">
                              <div class="col">
                                <h5>Text</h5>
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                              <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="accordion-notifications-check-2"
                                  checked="" />
