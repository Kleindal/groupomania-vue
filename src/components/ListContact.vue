...
export default {
  ...
  async mounted() {
    ...
    this.me = store.users.filter(user => user.id == userId)[0];
    this.users = store.users.filter(user => user.id != userId);
  },
}
</script>
            ...
            <div class="card mb-3">
              <div class="row g-0">
                ...
                <div class="">
                  ...
                  <div class="contact-footer px-4">
                    <p class="collapsible text-center">Voir ses derniers posts</p>
                    <div class="content">
                      <p>Lorem ipsum...</p>
                    </div>
                  </div>
