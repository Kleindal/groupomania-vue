...
export default {
  ...
  methods: {
    loadGroupPosts: async function(id) {
        const {data} = await this.axios.get('http://localhost:3006/api/groups/' + this.selectedGroup + '/posts', config);
...
<template>
  <div
    v-if="posts.length"
    class="col-12 col-md-9 col-lg-10 d-flex justify-content-center"
  >
        ...
        <div class="row">
          <div class="col-12 d-flex justify-content-center">
            <div class="card post">
              ...
              <div
                class="card-header d-flex align-items-center justify-content-evenly"
              >
                <div class="author">
                  <img v-if="post.author_image_url" :src="post.author_image_url" alt="" />
                  <svg v-else xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
              ...
              <div class="card-footer">
                <div class="comment text-center">
                  <a href="#" class="btn btn-primary" @click="likeOrUnlikePost(post)">
                    <svg v-if="post.connected_user_has_liked"
  ...
  <div
    v-else
    class="col-12 col-md-9 col-lg-10 text-center"
  >
    <h5>Ce groupe semble vide...</h5>
    <h6>Démarrer un nouveau post ?</h6>
    <h6 class="btn btn-primary">Créer
