...
<template>
  <div v-if="posts.length" class="col-12 col-md-9 col-lg-10 text-center">
            ...
            <div class="card-footer">
              <div class="comment text-center">
                <a
                  ...
                  @click="likeOrUnlikePost(post)"
                >
                  <svg
                    v-if="post.connected_user_has_liked"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
